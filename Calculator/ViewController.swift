...
class ViewController: UIViewController, EngineDelegate {
    ...
    @IBAction func subtractButtonTouched(sender: AnyObject) {
        
        self.engine?.addOperand(CalculatorOperation.Subtract)
    }
...
//    }
    ...
    @IBAction func twoButtonTouched(sender: AnyObject) {
